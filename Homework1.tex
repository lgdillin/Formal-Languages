...
\textbf{\textit{hypothesis:}}Since for any input symbol $a$,  $\delta(q,a)=q$, then any string of input symbols, $a_1, a_2, ... , a_n$, $\delta(q,a_i)=q$.\\
Let $w$ be a string of input symbols, and $b$ is the last symbol in the string $w$. Then $\delta(q,b)=q$.
